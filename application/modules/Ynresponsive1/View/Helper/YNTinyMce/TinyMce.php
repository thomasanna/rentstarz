...
class Ynresponsive1_View_Helper_YNTinyMce_TinyMce extends Zend_View_Helper_Abstract
{
  protected $_enabled = false;
  protected $_defaultScript = 'externals/tinymceres/tinymce.min.js';
  ...
  protected $_supported = array(
    ...
    //'plugins' => array('advlist', 'autolink', 'autosave', 'link', 'image', 'lists', 'charmap', 'print', 'preview', 'hr', 'anchor', 'pagebreak', 'spellchecker', 'searchreplace', 'wordcount', 'visualblocks', 'visualchars', 'code', 'fullscreen', 'insertdatetime', 'media', 'nonbreaking', 'table', 'contextmenu', 'directionality', 'emoticons', 'template', 'textcolor', 'paste', 'fullpage', 'textcolor'),
  );
  protected $_config = array(
    ...
    //'toolbar1' => array('newdocument', 'fullpage', '|', 'bold', 'italic', 'underline', 'strikethrough', '|', 'alignleft', 'aligncenter', 'alignright', 'alignjustify', '|', 'styleselect', 'formatselect', 'fontselect', 'fontsizeselect'),
    'toolbar2' => '',
    //'toolbar2' => array('cut', 'copy', 'paste', '|', 'searchreplace', '|', 'bullist', 'numlist', '|', 'outdent', 'indent', 'blockquote', '|', 'undo', 'redo', '|', 'link', 'unlink', 'anchor', 'image', 'media', 'code', '|', 'inserttime', 'preview', '|', 'forecolor', 'backcolor'),
    'toolbar3' => '',
    //'toolbar3' => array('table', '|', 'hr', 'removeformat', '|', 'subscript', 'superscript', '|', 'charmap', 'emoticons', '|', 'print', 'fullscreen', '|', 'ltr', 'rtl', '|', 'spellchecker', '|', 'visualchars', 'visualblocks', 'nonbreaking', 'template', 'pagebreak', 'restoredraft'),
    'element_format' => 'html',
    'height' => '225px',
    'convert_urls' => false
  );
...
//       $this->_config['toolbar3'] = array(
//       		'table', '|', 'hr', '|', 'removeformat', '|', 'subscript', '|', 'superscript', '|', 'charmap', '|', 'emoticons', '|', 'ltr', '|', 'rtl', '|', 'spellchecker', '|', 'visualchars', '|', 'visualblocks', '|', 'nonbreaking', '|', 'template', 'pagebreak', '|', 'restoredraft','cut', 'copy', 'paste', '|', 'searchreplace', '|', 'bullist', 'numlist', '|', 'outdent', 'indent', 'blockquote', '|', 'undo', 'redo', '|', 'link', 'unlink', 'anchor', 'image', 'media', 'code', '|', 'inserttime', 'preview', '|', 'forecolor', 'backcolor','newdocument', 'fullpage', '|', 'bold', 'italic', 'underline', 'strikethrough', '|', 'alignleft', 'aligncenter', 'alignright', 'alignjustify', '|', 'styleselect', 'formatselect', 'fontselect', 'fontsizeselect' 
//       );
