<?php
class Ynresponsive1_AdminContentController extends Core_Controller_Action_Admin
{
  ...
  public function widgetAction()
  {
    ...
    if( !empty($contentInfo[$name]['adminForm']) ) {
      ...
      $form->addElement('Select', 'nomobile', array(
        ...
        'label' => 'Hide on Tablet site?',
        'multiOptions' => array(
            '1' => 'Yes, do not display on Tablet site.',
            '0' => 'No, display on Tablet site.',
          ),
        'order' => 100000 - 6,
        'value' => '0',
      ));
			$form->addElement('Select', 'nofullsite', array(
        'label' => 'Hide on Full site?',
        'multiOptions' => array(
            '1' => 'Yes, do not display on Full site.',
            '0' => 'No, display on Full site.',
          ),
        'order' => 100000 - 5,
        'value' => '0',
      ));
    ...
    $this->view->form = $form = new Engine_Form(array(
      ...
      'elements' => array(
        ...
        array('Select','nomobile',array('label' => 'Hide on Mobile site?',
          'order' => 4,
          'multiOptions' => array(
            '1' => 'Yes, do not display on Mobile site.',
            '0' => 'No, display on Mobile site.',
          ...
          'value' => '0',)),
       array('Select','notablet',array('label' => 'Hide on Tablet site?',
          'order' => 5,
          'multiOptions' => array(
            '1' => 'Yes, do not display on Tablet site.',
            '0' => 'No, display on Tablet site.',
          ...
          'value' => '0',)),
         array('Select','nofullsite',array('label' => 'Hide on Full site?',
          'order' => 6,
          'multiOptions' => array(
            '1' => 'Yes, do not display on Full site.',
            '0' => 'No, display on Full site.',
