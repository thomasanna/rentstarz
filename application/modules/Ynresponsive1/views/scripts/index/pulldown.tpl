              ...
              <div class="content_info_div">
				...
				<div class="ynadvmenu_ContentlistInfo">
					<div class="ynadvmenu_NameUser" id="content_<?php echo $notification->getIdentity();?>">
						...
						<a class="feed_item_username" title="View Profile" href="/profile/<?php echo $notification->subject_id; ?>"><?php echo $subject->displayname;?></a> has sent a new task for maintenance.			
