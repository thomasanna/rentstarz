...
this.DatePicker = Picker.Date = new Class({
	...
	options: {/*
		...
		*/
		...
		time_title: function(date, options){
			return (options.pickOnly == 'time') ? en4.core.language.translate('select a time') : date.format('%d %B, %Y');
		}
	},
	...
	initialize: function(attachTo, options){
		...
		this.options.days_abbr = [
		en4.core.language.translate('Sun'),
		en4.core.language.translate('Mon'),
		en4.core.language.translate('Tue'),
		en4.core.language.translate('Wed'),
		en4.core.language.translate('Thu'),
		en4.core.language.translate('Fri'),
		en4.core.language.translate('Sat')];
	...
	renderDays: function(date, fx){
		...
		if(this.options.fnAfterRender){
			this.options.fnAfterRender(date);
		}
	},
...
var renderers = {
	...
	days: function(days, options, currentDate, dateElements, fn){
		var month = new Date(days[14]).get('month'),
			...
			localeDaysShort = options.days_abbr,
		...
		days.each(function(_date, i){
			...
			classes = '.day.ynevent-cal-day.day' + date.get('day');
			...
			element.set('id','yndc-'+getShortDateString(date));
