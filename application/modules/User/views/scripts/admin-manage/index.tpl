  ...
  <table class='admin_table'>
    <thead>
      <tr>
        ...
        <th style='width: 1%;' class='admin_table_centered'><?php echo $this->translate("Gender") ?></th>
        <th style='width: 1%;' class='admin_table_centered'><?php echo $this->translate("Birthdate") ?></th>
    ...
    <tbody>
      <?php if( count($this->paginator) ): ?>
		...
		if( !empty($fieldsByAlias['gender']) ) {
		  $optionId = $fieldsByAlias['gender']->getValue($user);
		  if( $optionId ) {
		...
		if( !empty($fieldsByAlias['birthdate']) ) {
          ...
          <tr>
            ...
            <td class='admin_table_centered'><?php echo $gender;?></td>
            <td class='admin_table_centered'><?php echo $this->timestamp($birthdate);?></td>
            ...
            <td class='admin_table_options'>
              ...
              |
              <a class='smoothbox' href='<?php echo $this->url(array('action' => 'userinfo', 'id' => $item->user_id));?>'>
