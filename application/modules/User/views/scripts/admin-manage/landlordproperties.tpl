  ...
  <table class='admin_table'>
    <thead>
      <tr>
        ...
        <th style='width: 1%;'><a href="javascript:void(0);" onclick="javascript:changeOrder('created_at', 'ASC');"><?php echo $this->translate("Landlord Enable") ?></a></th>
    ...
    <tbody>
       ...
       <td><?php echo $item['enable']; ?></td>
       <td><?php echo $item['landlord_enable']; ?></td>
