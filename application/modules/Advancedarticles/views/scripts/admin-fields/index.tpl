...
<a href="javascript:void(0);" onclick="void(0);" class="buttonlink admin_fields_options_saveorder" style="display:none;"></a>
<a href="javascript:void(0);" onclick="void(0);" class="buttonlink admin_fields_options_addquestion">Add Question</a>
</div>

<br />
<?php if (!$this->topLevelMaps) return; ?>

<ul class="admin_fields">
<?php foreach( $this->topLevelMaps as $article_map ): ?>
    <?php echo $this->adminFieldMeta($article_map) ?>
<?php endforeach; ?>
</ul>
